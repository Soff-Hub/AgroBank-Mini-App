...
const CameraComponent: React.FC = () => {
  ...
  async function getBrandCrums() {
    try {
      const response = await axios.get(`https://api.agro-net.uz/api/v1/common/blank/status/path/?parent=${dataPathFilter || ""}`)
  ...
  async function getStatusData() {
    try {
      const response = await axios.get(`https://api.agro-net.uz/api/v1/common/blank/status/?parent=${dataPathFilter || ''}`)
  ...
  const uploadToServer = async () => {
    ...
    try {
      ...
      const response = await axios.post("https://api.agro-net.uz/api/v1/common/blank/", formData, {
        headers: {
  ...
  async function getPermissions() {
    try {
      const response = await axios.get(`https://api.agro-net.uz/api/v1/common/employee/check/`, {
        headers: {
